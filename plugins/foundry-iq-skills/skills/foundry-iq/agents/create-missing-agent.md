...
Before approval, prepare the complete JSON body in a reviewed UTF-8 file:
...
No automatic cleanup. Preserve previous versions and shared resources.
Cleanup needs a separate ownership-checked plan and approval; connection cleanup
does not delete an agent container created here.
