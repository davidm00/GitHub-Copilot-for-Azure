...
Use for a reported Foundry IQ access, ingestion, retrieval, citation, connection,
tool/toolbox, identity, network, or preserved-agent deployment failure. Diagnose
read-only first; stop with explicit owner/handoff when cause belongs elsewhere.
