---
name: foundry-iq
description: "Foundry IQ knowledge bases. WHEN: make local or Blob documents searchable; create/diagnose KBs; connect existing KB to agents; create/reuse a Search service; retrieve from an existing knowledge base with citations; no brand words needed. Read its procedure before query/target questions. NOT: other KB providers, repository-file search, classic Azure AI Search index/query/app work, generic agent creation, unsupported connectors."
license: MIT
compatibility: Azure
metadata:
  author: Microsoft
...
Unclear/compound/completion: [read](references/intent-routing.md).
...
Unsupported/multi-source: Diagnose; never substitute.
