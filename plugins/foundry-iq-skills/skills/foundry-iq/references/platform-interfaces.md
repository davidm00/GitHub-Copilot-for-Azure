...
| AI account/deployment | ARM `2025-06-01`; File CU GET `2024-10-01` |
...
| Existing Prompt Agent connection | authenticated Foundry MCP preferred; `azure-ai-projects` 2.x typed-client fallback; Agent API `v1`; project-connection ARM API `2025-10-01-preview`; KB MCP endpoint `2026-08-01-preview` |
| Existing Hosted Agent connection | current `azd ai agent` read/deploy contract; agentic-identity project connection and Foundry toolbox; KB MCP endpoint `2026-08-01-preview` |
...
| Existing Hosted connection | exact `azd ai` connection/toolbox plus source deploy commands in `agents/connect.md` |
